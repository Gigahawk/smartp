...
def parse_args():
    parser = argparse.ArgumentParser(
        prog="smartp",
        description=(
            "Run a smart test on all SMART capable drives attached to the system"
        ),
    )
    parser.add_argument(
        "-t",
    ...
    parser.add_argument(
        "--threads", help="Number of tests to run simultaneously", default=20, type=int
    )
    parser.add_argument("--debug", help="Enable debug loggin", action="store_true")
